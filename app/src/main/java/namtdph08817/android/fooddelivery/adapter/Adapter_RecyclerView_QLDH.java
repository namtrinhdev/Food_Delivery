...
public class Adapter_RecyclerView_QLDH extends RecyclerView.Adapter<Adapter_RecyclerView_QLDH.QLDH_ViewHolder> {
    ...
    @NonNull
    @Override
    public Adapter_RecyclerView_QLDH.QLDH_ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_qldh, parent, false);
        return new Adapter_RecyclerView_QLDH.QLDH_ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Adapter_RecyclerView_QLDH.QLDH_ViewHolder holder, int position) {
