...
public class DangGiaoHangFragment extends Fragment {
    private static final String TAG = "DeliveringFrg";
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.id_recycle_danggiaohang);
        progressBar = view.findViewById(R.id.id_progressBar_DangGiaoHang);
        view_empty = view.findViewById(R.id.id_emptyView_dangGiaoHang);
    ...
    private void updateStatus(String id) {
        ...
        Call<Messages> call = api_interface.putDonHang(id,sessionManager.getVaiTro(),time,3);
    ...
    private void loadData() {
        ...
        Call<List<ThanhToan>> call = api_interface.getDsDangGiao(sessionManager.getIdUser());
