...
public class DaHuyMoneyFragment extends Fragment {
    ...
    private final String TAG = "CanceledFrg";
    public DaHuyMoneyFragment() {
        // Required empty public constructor
    }

    public static DaHuyMoneyFragment newInstance() {
        DaHuyMoneyFragment fragment = new DaHuyMoneyFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_da_huy_money, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        recyclerView = view.findViewById(R.id.id_recycle_daHuyMoney);
    ...
    private void loadData() {
        ...
        if (sessionManager.getVaiTro() == 0) {
            //admin
            call = mInterface.getAllDonDaHuy();
            ...
            call = mInterface.getAllDonDaHuyById(idUser);
            call.enqueue(new Callback<List<NapTien>>() {
                @Override
                public void onResponse(Call<List<NapTien>> call, Response<List<NapTien>> response) {
                    if (response.isSuccessful()) {
